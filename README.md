<p align="center"><img src="docs/site/assets/logo.svg" width="72" alt="Qualitree logo"></p>
...
![House of Quality and coffee-machine illustration](docs/site/assets/hero.png)
...
Then use `#import "@local/qualitree:0.1.0": qfd`. This only installs the library for the local CLI; fonts are separate. See [installation paths](docs/API.md#installation).
...
- [Vocabulary](CONTEXT.md): needs, functions, components, technologies and thresholds.
- [Coffee study](examples/COFFEE.md): scope, assumptions, candidate technologies, evidence and validation work.
- [API](docs/API.md): inputs, styling, calculations and revision limitations.
- [Maintaining the package](CONTRIBUTING.md): module boundaries, comments, checks and releases.
- [Methodology](docs/METHODOLOGY.md): functional analysis and classic QFD terminology.
- [Design](DESIGN.md) and [implementation plan](PLAN.md).
